<?php
    if ( ! defined('BASEPATH')) exit('No direct script access allowed');
       ...
       class HomeProducts extends CI_finecontrol{
       function __construct()
           ...
           public function view_added_home_products(){
              ...
              if(!empty($this->session->userdata('admin_data'))){
                ...
                $this->load->view('admin/homeproducts/view_added_home_products');
         ...
         public function view_products(){
            ...
            if(!empty($this->session->userdata('admin_data'))){
              ...
              $this->load->view('admin/common/header_view',$data);
              $this->load->view('admin/homeproducts/view_products');
              $this->load->view('admin/common/footer_view');
          ...
          public function add_home_product($id){
             ...
             if(!empty($this->session->userdata('admin_data'))){
               ...
               $addedby=$this->session->userdata('admin_id');
                          ...
                          $last_added_id=$this->base_model->insert_table("tbl_home_products",$data_insert,1) ;

                          if($last_added_id != 0){
                          $this->session->set_flashdata('smessage','Product Added successfully');
                          redirect("dcadmin/HomeProducts/view_products","refresh");
                        }
           ...
           public function remove_home_product($id){
              ...
              if(!empty($this->session->userdata('admin_data'))){
                ...
                $decode_id= base64_decode($id);
                           ...
                           $last_removed_id = $this->db->delete('tbl_home_products', array('product_id' => $decode_id));
