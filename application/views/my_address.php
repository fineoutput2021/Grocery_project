...
<img alt="logo" src="<?=base_url();?>assets/frontend/img/user.jpg">
...
<a href="<?=base_url();?>Home/my_address" class="list-group-item list-group-item-action active"><i aria-hidden="true" class="mdi mdi-map-marker-circle"></i> My Address</a>
