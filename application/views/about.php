...
<img class="rounded img-fluid" src="<?=base_url()?>assets/frontend/img/about.jpg" alt="Card image cap">
</div>
...
<img class="img-fluid mb-4" src="<?=base_url()?>assets/frontend/img/user/1.jpg" alt="">
...
<div class="col-lg-4 col-md-4">
<div class="team-card text-center">
<img class="img-fluid mb-4" src="<?=base_url()?>assets/frontend/img/user/2.jpg" alt="">
<p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
...
<div class="col-lg-4 col-md-4">
 <div class="team-card text-center">
<img class="img-fluid mb-4" src="<?=base_url()?>assets/frontend/img/user/3.jpg" alt="">
<p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
...
<p class="mb-0"><a class="text-success" href="#"><i class="mdi mdi-email"></i> <span class="__cf_email__" data-cfemail="147d75797b67757c757a547379757d783a777b79">[email&#160;protected]</span></a></p>
...
<script src="frontend/vendor/jquery/jquery.min.js" type="955f88119bd2e664b66b7423-text/javascript"></script>
<script src="frontend/vendor/bootstrap/js/bootstrap.bundle.min.js" type="955f88119bd2e664b66b7423-text/javascript"></script>

<script src="frontend/vendor/select2/js/select2.min.js" type="955f88119bd2e664b66b7423-text/javascript"></script>

 <script src="frontend/vendor/owl-carousel/owl.carousel.js" type="955f88119bd2e664b66b7423-text/javascript"></script>

<script src="js/custom.js" type="955f88119bd2e664b66b7423-text/javascript"></script>
<script src="js/rocket-loader.min.js" data-cf-settings="955f88119bd2e664b66b7423-|49" defer=""></script>
<script defer src="js/beacon.min.js" data-cf-beacon='{"version":"2021.2.0","r":1,"rayId":"62ca6592397818ba","si":10}'></script>
</html> -->
