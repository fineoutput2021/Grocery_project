...
<td> <input type="hidden" name="product_id"  class="form-control" placeholder="" required value="<?=$inventory_data->product_id;?>" />  </td>
</tr>
<tr>
<td> <strong>Select Product Type</strong>  <span style="color:red;">*</span></strong> </td>
<td> <select class="form-control" name="unit_id" required > <option value="1" <? if($inventory_data->unit_id==1){ echo "selected"; } ?>> 480kg </option> </select>  </td>
</tr>
<tr>
<td> <strong>Stock</strong>  <span style="color:red;">*</span></strong> </td>
<td> <input type="text" name="stock"  class="form-control" placeholder="" required value="<?=$inventory_data->stock;?>" />  </td>
</tr>
