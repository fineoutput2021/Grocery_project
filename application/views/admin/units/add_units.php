              ...
              <div class="col-lg-12">
                               ...
                               <div class="panel panel-default">
                                   ...
                                   <div class="panel-body">
                                       <div class="col-lg-10">
                                          <form action=" <?php echo base_url()  ?>dcadmin/units/add_units_data/<? echo base64_encode(1);  ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<td> <input type="text" name="suffix"  class="form-control" placeholder="" required value="" />  </td>
</tr>
