...
<?php if($user_pos =="Super Admin"){?>
														<li><a href="javascript:;" class="dCnf" mydata="<?php echo $i ?>">Delete Team Member </a></li>
                            <li><a href="<?php echo base_url() ?>dcadmin/system/update_team/<?php echo base64_encode($data->id); ?>">Update Team Member </a></li>
<?php } ?>
													  </ul>
													</div>
												</div>
