        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              ...
              <form action="<?php echo base_url() ?>dcadmin/home/add_slider_images_all/<?php echo base64_encode(2);?>/<?=$idd ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                ...
                ?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <input type="text" placeholder="Start url with http or https" value=<?=$edit_slider_images->link ?> name="link" class="form-control" ></input>
