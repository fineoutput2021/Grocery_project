              ...
              <div class="col-lg-12">
                               ...
                               <div class="panel panel-default">
                                   <div class="panel-heading">
                                       <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Add New Sub_category2</h3>
                                   </div>
                                   ...
                                   <div class="panel-body">
                                       <div class="col-lg-10">
                                          <form action=" <?php echo base_url()  ?>dcadmin/sub_category2/add_sub_category2_data/<? echo base64_encode(1);  ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<td> <input type="text" name="category_id"  class="form-control" placeholder=""  value="" />  </td>
</tr> -->
<tr>
<td> <strong>Category</strong>  <span style="color:red;">*</span></strong> </td>
...
<td> <input type="text" name="subtext1"  class="form-control" placeholder=""  value="" />  </td>
</tr>
  <tr>
