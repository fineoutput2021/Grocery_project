...
<div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Update Sub_category2 </h3>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="col-lg-10">
                           <form action=" <?php echo base_url(); ?>dcadmin/sub_category2/add_sub_category2_data/<? echo base64_encode(2); ?>/<?=$id;?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<?php if($sub_category2_data->image!=""){ ?> <img id="slide_img_path" height=200 width=300 src="<?php echo base_url().$sub_category2_data->image; ?> "> <?php }else{ ?> Sorry No File Found <?php } ?>  </td>
</tr>
