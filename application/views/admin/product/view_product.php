        ...
        <div class="row">
        <div class="col-lg-12">
        <a class="btn btn-info cticket" href="<?php echo base_url() ?>dcadmin/product/add_product"
   ...
   $this->db->select('*');
      ...
      $this->db->select('*');
            ...
            $subcat_dsa= $this->db->get()->row();
            if(!empty($subcat_dsa)){
              echo $subcat_dsa->name;
            }
          else{
            echo "Not available";
          }
 ...
 <?php } ?><br>
   ...
   <td>
   <?php if($data->app_image1!=""){ ?>
   <img id="slide_img_path"  style="border:solid red 1px;padding: 5px;" height=50 width=80 src="<?php echo base_url().$data->app_image1
   ?>" >
   <?php } ?>


   <?php if($data->app_image2!=""){ ?>
   <img id="slide_img_path" style="border:solid red 1px;padding: 5px;"  height=50 width=80 src="<?php echo base_url().$data->app_image2
   ?>" >
 <?php } ?><br>
   <?php if($data->app_image3!=""){ ?>
   <img id="slide_img_path" style="border:solid red 1px;padding: 5px;"  height=50 width=80 src="<?php echo base_url().$data->app_image3
   ?>" >
   <?php } ?>
   <?php if($data->app_image4!=""){ ?>
   <img id="slide_img_path" style="border:solid red 1px;padding: 5px;"  height=50 width=80 src="<?php echo base_url().$data->app_image4
   ?>" >
   <?php } ?>
   </td>
   ...
   <td>
   <?php if($data->app_pro_image!=""){ ?>
   <img id="slide_img_path" height=50 width=100 src="<?php echo base_url().$data->app_pro_image
   ?>" >
   <?php }else { ?>
   Sorry No File Found
   <?php } ?>
   ...
   <td>
   <?php if($data->app_main_image!=""){ ?>
   <img id="slide_img_path" height=50 width=100 src="<?php echo base_url().$data->app_main_image
   ?>" >
   <?php }else { ?>
   Sorry No File Found
   <?php } ?>
