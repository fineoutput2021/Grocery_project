...
<td> <input type="text" name="name"  class="form-control" placeholder="" required />  </td>
</tr>
  <tr>
...
<td> <input type="number" name="sort_id"  class="form-control" placeholder="" required />  </td>
</tr>
...
<td> <input type="text" name="subtext2"  class="form-control" placeholder="" required />  </td>
</tr>
