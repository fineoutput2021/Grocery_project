...
<?php if($category_data->app_image!=""){ ?><img id="slide_img_path" height=200 width=300 src="<?php echo base_url().$category_data->app_image; ?> "> <?php }else{ ?> Sorry No File Found <?php } ?>  </td>
</tr>

<tr>
<td> <strong>Sort Id</strong>  <span style="color:red;">*</span></strong> </td>
<td> <input type="number" name="sort_id"  class="form-control" placeholder="" required  value="<?=$category_data->sort_id;?>"/>  </td>
</tr>

<tr>
<td> <strong>SubText1</strong>  <span style="color:red;">*</span></strong> </td>
<td> <input type="text" name="subtext1"  class="form-control" placeholder="" value="<?=$category_data->subtext1;?>" />  </td>
</tr>

<tr>
<td> <strong>SubText2</strong>  <span style="color:red;">*</span></strong> </td>
<td> <input type="text" name="subtext2"  class="form-control" placeholder="" value="<?=$category_data->subtext2;?>" />  </td>
</tr>
