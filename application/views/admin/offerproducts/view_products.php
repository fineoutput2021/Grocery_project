        ...
        <div class="row">
        <div class="col-lg-12">
        <a class="btn btn-info cticket" href="<?php echo base_url() ?>dcadmin/FestiveProducts/view_added_home_products"
 ...
 <?php } ?><br>
   ...
   <?php } ?>
        ...
        <?php  if(empty($homeproduct)){ ?>
              <a href="<?php echo base_url() ?>dcadmin/FestiveProducts/add_home_product/<?php echo base64_encode($data->id); ?>">
      ...
      <?php } else{ ?>
              ...
              <a href="<?php echo base_url() ?>dcadmin/FestiveProducts/remove_home_product/<?php echo base64_encode($data->id); ?>">
                  <button type="button" class="btn btn-default " aria-expanded="false">
                  Remove </button>
              </a>
        <?php } ?>
