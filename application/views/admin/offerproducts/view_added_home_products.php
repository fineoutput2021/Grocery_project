        ...
        <h1>
          View Added OfferProducts
        </h1>
        </section>
        <section class="content">
        <div class="row">
        <div class="col-lg-12">
        <a class="btn btn-info cticket" href="<?php echo base_url() ?>dcadmin/FestiveProducts/view_products"
        role="button" style="margin-bottom:12px;"> Add New Offer Product</a>
        <div class="panel panel-default">
        <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>  View Added OfferProducts</h3>
        </div>
        <div class="panel panel-default">
