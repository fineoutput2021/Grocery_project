        ...
        <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View Cart Category</h3>
        </div>
        <div class="panel panel-default">
...
<!-- <td><?php //echo $data->sort_id ?></td> -->
        ...
        <div class="btn-group">
          <a href="<?php echo base_url() ?>dcadmin/users/view_cart_product/<?php echo $user_id ?>/<?php echo base64_encode($data->id) ?>">
