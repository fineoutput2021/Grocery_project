 	 ...
 	 <td><?php echo $data->wallet ?></td>
        ...
        base64_encode($data->id) ?>">Edit</a></li>
         <li><a href="<?php echo base_url() ?>dcadmin/users/view_user_cart/<?php echo
        base64_encode($data->id) ?>">view cart</a></li>
        <li><a href="<?php echo base_url() ?>dcadmin/users/view_cart_cate/<?php echo
       base64_encode($data->id) ?>">Add Cart</a></li>

       <li><a href="<?php echo base_url() ?>dcadmin/users/add_wallet_blance/<?php echo
      base64_encode($data->id) ?>">Add Wallet Balance</a></li>
