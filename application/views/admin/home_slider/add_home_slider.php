              ...
              <div class="col-lg-12">
                               ...
                               <div class="panel panel-default">
                                   <div class="panel-heading">
                                       <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Add New Home_slider</h3>
                                   </div>
                                   ...
                                   <div class="panel-body">
                                       <div class="col-lg-10">
                                          <form action=" <?php echo base_url()  ?>dcadmin/home_slider/add_home_slider_data/<? echo base64_encode(1);  ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                                       <div class="table-responsive">
                                           <table class="table table-hover">
  <tr>
<td> <strong>Image Name</strong>  <span style="color:red;">*</span></strong> </td>
<td> <input type="text" name="image_name"  class="form-control" placeholder=""  value="" />  </td>
</tr>
<tr>
<td> <strong>Category</strong>  <span style="color:red;">*</span></strong> </td>
<td><select class="form-control" name="category_id" id="category">
...
<td> <select class="form-control" name="subcategory_id" id="sub_category">
...
<td> <select class="form-control" name="device"  > <option value="1"> Phone </option><option value="2"> Desktop </option><option value="3"> Both </option> </select>  </td>
</tr>
