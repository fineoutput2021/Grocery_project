        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              ...
              <form action="<?php echo base_url() ?>dcadmin/AppSlider/add_appslider_images_all/<?php echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
