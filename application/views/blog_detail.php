...
<a href="#"><img class="card-img-top" src="<?=base_url()?>assets/frontend/img/blog/2.png" alt="Card image cap"></a>
</div>
<div class="card-body">
...
<div class="row">
<div class="col-sm-4"><img class="rounded" alt="" src="<?=base_url()?>assets/frontend/img/blog/3.png"></div>
<div class="col-sm-4"><img class="rounded" alt="" src="<?=base_url()?>assets/frontend/img/blog/2.png"></div>
<div class="col-sm-4"><img class="rounded" alt="" src="<?=base_url()?>assets/frontend/img/blog/1.png"></div>
</div>
</div>
<p>Praesent aliquam, enim at fermentum mollis, ligula massa adipiscing nisl, ac euismod nibh nisl eu lectus. Fusce vulputate sem at sapien. Vivamus leo. Aliquam euismod libero eu enim. Nulla nec felis sed leo placerat imperdiet. Aenean suscipit nulla in justo.</p>
...
<div class="row">
<div class="col-sm-6"><img alt="" class="rounded" src="<?=base_url()?>assets/frontend/img/blog/2.png"></div>
<div class="col-sm-6"><img alt="" class="rounded" src="<?=base_url()?>assets/frontend/img/blog/3.png"></div>
</div>
</div>
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non, ipsum facilis, eaque aliquid porro deleniti architecto eum perferendis quidem modi quo reiciendis dolor deserunt beatae repellat, nostrum aut fuga. Rem?</p>
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis sunt a quam, exercitationem, provident numquam quia eius optio quos vitae odio impedit ipsum voluptatem earum neque architecto enim quisquam, ea.</p>
...
<img alt="" src="<?=base_url()?>assets/frontend/img/user/1.jpg" class="d-flex mr-3 rounded">
...
<div class="media">
<img alt="" src="<?=base_url()?>assets/frontend/img/user/2.jpg" class="d-flex mr-3 rounded">
<div class="media-body">
...
<img alt="" src="<?=base_url()?>assets/frontend/img/user/3.jpg" class="d-flex mr-3 rounded">
<div class="media-body">
